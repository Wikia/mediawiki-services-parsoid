...
var url = require('url'),
	...
	Infobox = require('./ext.Infobox.js').Infobox,
...
insertInMaps( 'mediawikiwiki', 'www.mediawiki.org', '/w/api.php', 'https://' );
insertInMaps( 'commonswiki', 'commons.wikimedia.org', '/w/api.php', 'https://' );
insertInMaps( 'sourceswiki', 'wikisource.org', '/w/api.php', 'https://' );
